...
@mark.parametrize(
    ...
    [
        ...
        (
            "/*",
            {"wildcard": "source/page/50"},
            {"wildcard": "random/"},
            {"wildcard": None},
            {"wildcard": "r1/page/r2"},
        ),
        ("/source/page/50*", {"wildcard": None}, None, None, None),
        ("/source/page/50/*", None, None, None, None),
        ...
        (
            ...
            {"from": "random", "wildcard": None},
            None,
            {"from": "r1", "wildcard": "page/r2"},
        ),
        (
            "/:from/*/:id",
        ...
        (
            ...
            None,
            None,
            {"wildcard": "r1/page", "c": "r2"},
        ),
        ("/*/:b/50/", {"wildcard": "source", "b": "page"}, None, None, None),
    ],
)
def test_path_matching(path, e1, e2, e3, e4):
    ...
    req1 = mock.Mock(
        path="/source/page/50", host="foo.asyncyapp.com.storyscriptapp.com"
    )
